...
if(isset($_POST['addpage'])){
	...
	$sqlQry="UPDATE `terms` SET `content`='$content',`status`='1',`date`='$date' WHERE `id` ='$id'";

$excQry=mysqli_query($con,$sqlQry);
 if($excQry ){
		header("location:viewpage.php?msg=ups");
	}else{
		header("location:terms.php?msg=inf");
	}
	}
?>
<!doctype html>
...
<head>
<meta charset="utf-8" />
<title>Terms Page| <?php echo getSiteTitle(17); ?> </title>
...
<h4 class="mb-3 font-size-18">Terms</h4>
...
<form id="myform" action="" method="post"   enctype="multipart/form-data">
	...
	<?php $fetch=mysqli_fetch_array(mysqli_query($con,"select * from terms where id='1'")); ?>
