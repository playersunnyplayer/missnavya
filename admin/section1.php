...
$excQry=mysqli_query($con,$sqlQry);
 if($excQry ){
		header("location:section1.php?msg=ins");
	}else{
		header("location:section1.php?msg=inf");
	}
	}
...
<head>
<meta charset="utf-8" />
<title>Section One | <?php echo getSiteTitle(17); ?> </title>
...
<h4 class="mb-3 font-size-18">Section One</h4>
...
<div class="col-6" style="text-align:right">
	...
	<form id="myform" action="" method="post"   enctype="multipart/form-data">
		<?php $fetch=mysqli_fetch_array(mysqli_query($con,"select * from websitehomepage where section='1'")); ?>
