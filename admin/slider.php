...
if(isset($_GET['msg'])&&$_GET['msg']!=''){
	...
	break;
	case 'dls':
		$msg='<strong>Success!</strong> Image Deleted Successfully !!';
		$class='success';
	break;
	case 'dlf':
...
<head>
<meta charset="utf-8" />
<title>View Slider | <?php echo getSiteTitle(17); ?> </title>
...
<h4 class="mb-3 font-size-18">Slider Image</h4>
...
<?php
$i=0;
$qry=mysqli_query($con,"select * from websiteslider  order by id desc");
...
<td><img src="../assets/img/slide/<?php echo $product['image'] ?>" alt="" class="avatar-sm" style="max-height: 50px;
    max-width: 100px;
    height: auto;
    width: auto;"></td>
<td><?php echo ($product['heading']) ?></td>
<td><?php echo getStatus($product['status']) ?></td>
<td>
<a href="editslider.php?sid=<?php echo ($product['id']) ?>"  ><button class="btn btn-info btn-md waves-effect waves-light" type="button"><i class="bx bx-edit" ></i> Edit</button></a>
</td>
<td>
...
<div class="modal-content">
  <div class="modal-body">
                                   ...
                                   <div class="row justify-content-center">
                                       <div class="col-xl-10">
																				 <form id="myform" class="" enctype="multipart/form-data" method="post">
																					 <div  class="mb-3 col-md-12"><label for="name">Heading </label>
																					 	 <input class="form-control form-control" id="heading" type="text" name="heading" placeholder="Slider Heading">
																				 </div>
																				...
																				<textarea name="content" class="form-control " rows="8" cols="80"></textarea>
	 																				...
	 																				<input class="form-control form-control" id="image2" type="file" name="image2" onchange="readURL(this);">
	 																				</div>
																					<div class="mb-3 col-md-12">
																					<button type="submit" name="addpage" class="btn btn-success w-md btn-md">Add</button> <button type="button" data-bs-dismiss="modal" aria-label="Close"   class="btn btn-outline-success btn-md w-md">Cancel</button>
																					</div>
																				 </form>
