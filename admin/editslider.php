...
$filename2=$_FILES['image']['name'];
  ...
  if(in_array($file_extension,$valid_ext)){
	...
	$sqlQry="UPDATE `websiteslider` SET `heading`='$heading',`content`='$content',`image`='$filename',`status`='1',`date`='$date' WHERE `id` =$id";
 }else{
	 	$sqlQry="UPDATE `websiteslider` SET `heading`='$heading',`content`='$content',`status`='1',`date`='$date' WHERE `id` = '$id' ";

 }
$excQry=mysqli_query($con,$sqlQry);
 if($excQry ){
		header("location:slider.php?msg=ups");
	}else{
		header("location:slider.php?msg=upf");
	}
	}
...
<head>
<meta charset="utf-8" />
<title>Edit Slider Image| <?php echo getSiteTitle(17); ?> </title>
...
<h4 class="mb-3 font-size-18">Edit Silder</h4>

                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                                           	<li class="breadcrumb-item"> <a href="#">Home Page</a></li>
                                            <li class="breadcrumb-item"><a href="slider.php">Slider Image</a></li>
...
<div class="col-6" style="text-align:right">
	...
	<form id="myform" action="" method="post"   enctype="multipart/form-data">
		<?php $fetch=mysqli_fetch_array(mysqli_query($con,"select * from websiteslider where id='$id'")); ?>
...
<div  class="mb-3 col-lg-12" >
			...
			<div  class="mb-3 col-lg-12"><label for="name">Image</label><input class="form-control form-control" id="image" type="file" name="image" onchange="readURL(this);"></div>

		</div>
			<div  class="mb-3 col-lg-6" >
				<label for="name">Image </label>	<br>
				<img id="pimage" style="max-width: 100%;max-height:400px" src="../assets/img/slide/<?php echo $fetch['image'] ?>"  alt="">
			</div>
			</div>
			<div class="row">
			</div>
